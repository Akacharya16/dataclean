filesPath <- "C:/TheWonderfulCompany/Cerificate/Data-Science/Data-Cleaning/getdata%2Fprojectfiles%2FUCI HAR Dataset/UCI HAR Dataset"
setwd(filesPath)
...
##########Q5 ##################
write.table(dataTable, "AKATidyData.txt", row.name=FALSE)
